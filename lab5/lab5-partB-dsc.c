...
#define IWDG_KEY_RELOAD	0xAAAA	// Reload key
#define IWDG_KEY_ENABLE	0xCCCC	// Enable key 
#define IWDG_KEY_WRITE	0x5555	// Prescaler/reload write key
...
void IWDG_init(uint8_t prescaler, uint16_t reload) {
	...
	// Kick watchdog to start countdown
...
int main(void){
	...
	// Flash LEDs 3 times to complete setup
	turn_off_LED1();
	turn_off_LED2();
	int i, j;
	for (i = 0; i < 6; i++) {
